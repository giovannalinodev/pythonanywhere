...
class DuplicadoExemploView1(View):
    """View de exemplo para gerar código duplicado."""
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'acervo/exemplo1.html', contexto)
...
class DuplicadoExemploView2(View):
    """View de exemplo 2 para gerar código duplicado."""
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'acervo/exemplo2.html', contexto)
